...
image_list = listdir('vincent_photos')
...
image_folder_url = 'https://mdsi-innodata.s3-ap-southeast-2.amazonaws.com/Vincent/'
...
# image_list = ['IMG_20190905_215342.jpg',]

for image_file in image_list:
	if image_file.endswith(".jpg"):

		image_date = re.split("_", image_file)[0]

		print(image_file)

		image_time = re.split('\.', re.split("_", image_file)[1])[0]
